...
import fasdatec from './recover.module.scss';
const recoverform = () => {
  return (
    <>
        <section className={fasdatec.commu__container__form__forget}>
            <article className={fasdatec.commu__form__steps}>
                <h2 className={fasdatec.commu__title__head__pass}>Recuperación de tu Contraseña</h2>
                <p className={fasdatec.commu__title__parra__pass}>Te enviaremos un código para que puedas reestablecer tu contraseña</p>
                <form>
                    <div className={fasdatec.commu__form__group}>
                        <div className={fasdatec.commu__form__desing}>
                            ...
                            <label htmlFor="mail" className={fasdatec.commu__label__form}>Correo Electronico de Logueo</label>
                        </div>
                    ...
                    <div className={`${fasdatec.commu__form__group} ${fasdatec.commu__bottom}`}>
                        <span className={`${fasdatec.commu__span__text} ${fasdatec.commu__span__text__resp}`}>¿Solo querias ver el Diseño? 
                        <a href="/" className={fasdatec.commu__link__text}> Da un clic aqui para hacer login</a></span>
                    </div>
                    <button className={fasdatec.commu__btn}>Mandar Código</button>
                </form>
            </article>
        </section>
    </>
