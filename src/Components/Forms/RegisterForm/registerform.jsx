    ...
    <>
        <section className={fasdatec.commu__container__form}>
            <article className={fasdatec.commu__form__wave}>
                <div className={fasdatec.commu__img__register}>
                    <h1 className={fasdatec.commu__title__head}>¡Experiencia Unica!</h1>
                    <img src={imgRegister} className={fasdatec.img__commu} loading="lazy" alt="Comunity Manager de FasdaTec" title="Comunity Manager de FasdaTec" />
                </div>
            </article>
